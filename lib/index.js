...
const THIRTY_MINUTOS = 30 * 60 * 1000;
const WEST_REGION = 'eu-west-1';
...
module.exports = ({
  ...
  endpoint,
  region = WEST_REGION,
  urlExpiryMilliseconds = THIRTY_MINUTOS,
  ...
  const validateFileUpload = async (fileKey) => {
    ...
    if (error) {
      ...
      throw new Error('The uploaded file does not have any content whatsoever!');
    }
